                    ...
                    <a style="color:white;" class="btn btn-dark btn-block">Insert Menu</a>
                                      <div class="form-group col-md-12">
                                        ...
                                        <select class="form-control" id="field" name="field">
                                          <option><?php echo $fieldid; ?></option>
                                      </select>
                                      </div>
                                      <div class="form-group col-md-12">
                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php if(isset($_POST['find'])){
                                 $search=$_POST['search'];
                                 $query="select * from questions where (field LIKE '%$search%' OR year LIKE '%$search%' OR semester LIKE '%$search%' OR filename LIKE '%$search%') AND (field LIKE '$fieldid')";
                                $result= mysqli_query($link, $query);
                                $count=0;
                    while($row= mysqli_fetch_array($result))
                    {
      ...
      $(document).ready(function(){
		...
		// Create an FormData object 
            ...
            success: function (data) {
                ...
                var delay=1000;
                setTimeout(function(){
               window.location.href = '../control/decidequestion_control';
             },delay);
            }
            });
            }
