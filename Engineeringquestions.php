                ...
                <table class="table table-striped table-hover">
                    ...
                    <tbody>
                        <?php if(isset($_POST['find'])){
                                 $search=$_POST['search'];
                                 $query="SELECT * FROM questions where (field LIKE '%$search%' OR branchname LIKE '%$search%' OR year LIKE '%$search%' OR semester LIKE '%$search%' OR filename LIKE '%$search%') AND (field LIKE '$fieldid')";
                                 $result= mysqli_query($link, $query);
                                $count=0;
                    while($row= mysqli_fetch_array($result))
                    {
